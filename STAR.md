...
**Context:** tier-1 carrier has a massive product catalog with 10,000+ products across 50 categories, managed via TMF620 (Product Offering) and TMF622 (Product Ordering) APIs. Customer support agents and sales teams struggle to:
...
**Situation:**
> "tier-1 carrier has 10,000+ products across 50 categories. Customer support and sales teams struggled to find products, validate orders, and troubleshoot failures. Manual lookup took 45 seconds, and 12% of orders failed."
